...
instantiator(_) ->
    ...
    CreateResult1 = molderl:create_stream(bar,?MCAST_GROUP_IP,BarPort,LocalHostIP,100),
    CreateResult2 = molderl:create_stream(baz,?MCAST_GROUP_IP,BazPort,LocalHostIP,200),
    CreateResult3 = molderl:create_stream(foo,?MCAST_GROUP_IP,FooPort,LocalHostIP,100),
    CreateResult4 = molderl:create_stream(bar,?MCAST_GROUP_IP,BarPort,LocalHostIP,100),
